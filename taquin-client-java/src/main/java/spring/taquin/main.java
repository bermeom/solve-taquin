...
public class main {
    ...
    public static  List<List<String > > loadBoards(){
            ...
            boars.get(7-4).add("5 36 42 13 33 21 23 31 29 45 6 43 39 44 10 12 46 14 26 30 2 3 35 20 47 4 40 34 27 48 15 11 16 28 9 41 7 38 32 24 17 25 0 8 18 1 19 37 22");
            boars.get(8-4).add("14 30 32 4 47 58 16 56 40 19 35 3 61 33 55 44 31 53 22 50 1 18 28 38 60 54 23 59 7 11 21 10 36 43 17 9 37 41 12 39 2 57 15 8 62 5 42 48 52 34 46 26 63 27 24 51 45 13 29 0 49 20 25 6");
            boars.get(9-4).add("2 1 10 6 17 11 20 18 16 22 21 27 33 41 25 15 42 14 9 19 3 78 7 46 29 65 36 30 8 37 68 4 28 32 12 13 55 38 54 24 57 61 45 59 50 51 58 75 49 26 52 53 63 31 72 69 44 48 39 80 77 62 76 60 43 71 23 34 35 67 5 66 70 64 79 40 74 47 73 56 0");
            return boars;
    }
